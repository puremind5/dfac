...
const CHEST_VALUES = [10, 20, 50, 100]; // Исправленные значения сундуков
    ...
    <div className="text-center">
      ...
      <div className="bg-gray-800 text-white p-4 rounded-lg shadow-lg mb-4">
        ...
        <ul className="text-sm space-y-1">
          ...
          <li>• Each chest has a different value: 10, 20, 50, or 100 gold</li>
          <li>• If only you choose the most valuable chest, you get the gold</li>
          <li>• If multiple players choose the same chest, no one gets gold</li>
        </ul>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 justify-center">
        {CHEST_VALUES.map((value, index) => (
          <button
            ...
            onClick={() => onChestSelect(index)} // Передаём индекс без +1
            disabled={loading}
          >
            💰 {value} Gold
          </button>
